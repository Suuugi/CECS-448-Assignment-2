...
$(document).ready( function() { 
		$('#finances').mouseover(function(){
			...
			$('#parking h5').fadeTo( 0, 0.33 );
			$('#academics h5').fadeTo( 0, 0.33 );
			$('#calendars h5').fadeTo( 0, 0.33 );
			$('#housing h5').fadeTo( 0, 0.33 );
			$('#resources h5').fadeTo( 0, 0.33 );
		});
